...
for date_var in reg_season_to_date_22_23:
...
full_df_dates.to_sql('bronze_nba_player_measures_22_23', con = engine, if_exists = 'replace', index = False, index_label=None)      

#df = pd.read_sql("""select  * from bronze_nba_player_measures_22_23""",con)
#df
